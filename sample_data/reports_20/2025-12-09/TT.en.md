...
No thesis match: MRS_20 -5.0% below STRENGTH zone (4.0-10.0%); PEG 2.67 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($379.34)
...
MRS_20 deteriorating from -3.9% to -5.0% (-1.1% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 9.0pp (needs >4.0% for momentum thesis). Underperforming sector by 3.5pp, stock-specific weakness. Below SMA200 (0.98x), long-term trend not supportive. MACD histogram bearish (-1.52), momentum weakening.
...
- **Entry:** $399.00
- **Stop Loss:** $379.34 (4.9% risk)
- **Target:** $418.66 (R:R method)
- **Risk/Reward:** 1.00:1
