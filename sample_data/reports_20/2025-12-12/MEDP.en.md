...
No thesis match: MRS_20 -4.1% below STRENGTH zone (4.0-10.0%); PEG 3.59 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_20 strengthening from -8.4% to -4.1% (+4.3% in 5 days), confirming momentum buildup. Below STRENGTH zone by 8.1pp (needs >4.0% for momentum thesis). MRS_5 turning positive (1.8%) - potential reversal signal. AM_20 at -3.7% indicates price below own 20MA trend. Underperforming sector by 3.8pp, stock-specific weakness. Long-term uptrend intact (above SMA200 at 1.34x) but short-term weakness (below SMA20). MACD histogram bearish (-4.60), momentum weakening. RSI neutral at 44. OFD pattern: -MTL (Decline).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -4.11% (CS: 11) | Weak |
| RSI_14 | 43.6 | Neutral |
