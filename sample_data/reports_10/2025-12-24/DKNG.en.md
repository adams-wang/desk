...
No thesis match: MRS_10 -2.2% below STRENGTH zone (3.0-6.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-1.7% MRS).
...
MRS_10 deteriorating from -0.5% to -2.2% (-1.7% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 5.2pp (needs >3.0% for momentum thesis). Underperforming sector by 3.2pp, stock-specific weakness. Below SMA200 (0.91x), long-term trend not supportive. RSI neutral at 54. OFD pattern: +SUL (Resistance test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -2.17% (CS: 24) | Weak |
| RSI_14 | 54.5 | Neutral |
