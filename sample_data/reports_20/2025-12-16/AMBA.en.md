...
No thesis match: MRS_20 -7.7% below STRENGTH zone (4.0-10.0%); PEG 4.96 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: declining volume (55% of avg), momentum weakening (-3.0% MRS).
...
MRS_20 deteriorating from -4.7% to -7.7% (-3.0% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 11.7pp (needs >4.0% for momentum thesis). AM_20 at -7.7% indicates price below own 20MA trend. Underperforming sector by 7.4pp, stock-specific weakness. Long-term uptrend intact (above SMA200 at 1.07x) but short-term weakness (below SMA20). Volume at 55% of 20MA suggests lack of conviction. OFD pattern: -SBL (Volatile).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -7.74% (CS: 4) | Weak |
| RSI_14 | 39.1 | Neutral |
