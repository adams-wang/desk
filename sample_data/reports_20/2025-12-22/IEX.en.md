...
No thesis match: MRS_20 1.1% below STRENGTH zone (4.0-10.0%); PEG 1.70 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($172.86)
...
PEG ratio 1.70 elevated, pricing in significant growth expectations. Forward P/E 21.6x stretched relative to 5% growth. Balance sheet: strong liquidity (2.9x). Institutional flow bullish (7 buying vs 3 selling).
...
MRS_20 weakening modestly (-1.0% over 5 days). Below STRENGTH zone by 2.9pp (needs >4.0% for momentum thesis). MRS_5 (-0.3%) diverging from MRS_20 - short-term weakness emerging. Full SMA alignment bullish (above 20/50/200 SMAs). Elevated volume (1.3x 20MA), institutional activity likely. OFD pattern: +SLL (Support).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | 1.15% (CS: 59) | Neutral |
| RSI_14 | 61.5 | Neutral |
