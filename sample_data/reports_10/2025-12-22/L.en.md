...
No thesis match: MRS_10 2.2% below STRENGTH zone (3.0-6.0%); PEG 2.69 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_10 improving modestly (+0.7% over 5 days). Below STRENGTH zone by 0.8pp (needs >3.0% for momentum thesis). MRS_5 at 0.5% confirms short-term momentum alignment. Full SMA alignment bullish (above 20/50/200 SMAs). OFD pattern: +FTL (Rally).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 2.16% (CS: 83) | Neutral |
| RSI_14 | 63.9 | Neutral |
