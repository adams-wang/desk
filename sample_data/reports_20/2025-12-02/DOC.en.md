...
No thesis match: MRS_20 0.0% below STRENGTH zone (4.0-10.0%); PEG 4.08 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-3.1% MRS).
...
MRS_20 deteriorating from 3.1% to 0.0% (-3.1% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 4.0pp (needs >4.0% for momentum thesis). Below SMA200 (0.99x), long-term trend not supportive. RSI neutral at 52.

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | 0.00% (CS: 61) | Neutral |
| RSI_14 | 51.7 | Neutral |
