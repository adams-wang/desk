...
MRS_10 weakening modestly (-0.7% over 5 days). Below STRENGTH zone by 3.3pp (needs >3.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.03x) but short-term weakness (below SMA20). MACD histogram bearish (-0.82), momentum weakening. RSI neutral at 55. OFD pattern: +DUL (Resistance).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -0.31% (CS: 52) | Neutral |
| RSI_14 | 54.6 | Neutral |
