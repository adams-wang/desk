...
No thesis match: MRS_20 -1.1% below STRENGTH zone (4.0-10.0%); PEG 3.17 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_20 strengthening from -6.3% to -1.1% (+5.1% in 5 days), confirming momentum buildup. Below STRENGTH zone by 5.2pp (needs >4.0% for momentum thesis). MRS_5 turning positive (2.1%) - potential reversal signal. Underperforming sector by 4.1pp, stock-specific weakness. Below SMA200 (0.95x), long-term trend not supportive. MACD histogram bearish (-0.78), momentum weakening. RSI neutral at 44. OFD pattern: -MLN (Support test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -1.15% (CS: 26) | Neutral |
| RSI_14 | 43.5 | Neutral |
