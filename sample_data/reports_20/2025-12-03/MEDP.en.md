...
No thesis match: MRS_20 -4.8% below STRENGTH zone (4.0-10.0%); PEG 3.60 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-6.1% MRS).

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($541.83)
...
PEG ratio 3.60 signals overvaluation risk, limited margin of safety. Forward P/E 34.9x stretched relative to 9% growth. Quality metrics strong (ROE 74%, ROA 16%, margin 18%). Insider selling cluster ($217.3M in 90 days), potential headwind. Institutional flow bullish (5 buying vs 5 selling).
...
MRS_20 deteriorating from 1.3% to -4.8% (-6.1% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 8.8pp (needs >4.0% for momentum thesis). Underperforming sector by 4.6pp, stock-specific weakness. Long-term uptrend intact (above SMA200 at 1.41x) but short-term weakness (below SMA20). MACD histogram bearish (-4.61), momentum weakening. RSI neutral at 46. OFD pattern: -SUN (Resistance).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -4.82% (CS: 10) | Weak |
| RSI_14 | 46.1 | Neutral |
...
- **Entry:** $576.49
- **Stop Loss:** $541.83 (6.0% risk)
- **Target:** $611.15 (R:R method)
- **Risk/Reward:** 1.00:1
