...
No thesis match: MRS_10 -0.1% below STRENGTH zone (3.0-6.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-6.0% MRS).

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($196.98)
...
MRS_10 deteriorating from 5.9% to -0.1% (-6.0% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 3.1pp (needs >3.0% for momentum thesis). Full SMA alignment bullish (above 20/50/200 SMAs). RSI neutral at 51. OFD pattern: -SLH (Support test).
