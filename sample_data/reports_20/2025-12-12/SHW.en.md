...
No thesis match: MRS_20 -1.8% below STRENGTH zone (4.0-10.0%); PEG 3.17 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_20 strengthening from -4.7% to -1.8% (+3.0% in 5 days), confirming momentum buildup. Below STRENGTH zone by 5.8pp (needs >4.0% for momentum thesis). MRS_5 turning positive (2.0%) - potential reversal signal. Underperforming sector by 4.4pp, stock-specific weakness. Below SMA200 (0.95x), long-term trend not supportive. MACD histogram bearish (-0.95), momentum weakening. RSI neutral at 44. OFD pattern: -SLL (Support test).
