...
No thesis match: MRS_20 2.8% below STRENGTH zone (4.0-10.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-6.4% MRS).
...
MRS_20 deteriorating from 9.2% to 2.8% (-6.4% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 1.2pp (needs >4.0% for momentum thesis). MRS_5 (-1.7%) diverging from MRS_20 - short-term weakness emerging. Below SMA200 (0.90x), long-term trend not supportive. RSI neutral at 54. OFD pattern: -SUL (Resistance).
