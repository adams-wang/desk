...
No thesis match: MRS_10 2.4% below STRENGTH zone (3.0-6.0%); PEG 1.48 fails VALUE criteria (<1.0); RSI 79 overbought. Stock is in no-man's land without clear edge. Caution: momentum weakening (-2.8% MRS), overbought RSI (79).
...
MRS_10 deteriorating from 5.2% to 2.4% (-2.8% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 0.6pp (needs >3.0% for momentum thesis). MRS_5 (-0.0%) diverging from MRS_10 - short-term weakness emerging. Full SMA alignment bullish (above 20/50/200 SMAs). RSI overbought at 79, risk of mean reversion. OFD pattern: +DBN (Indecision).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 2.37% (CS: 73) | Neutral |
