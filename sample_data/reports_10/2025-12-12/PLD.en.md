...
MRS_10 strengthening from -2.0% to 2.3% (+4.3% in 5 days), confirming momentum buildup. Below STRENGTH zone by 0.7pp (needs >3.0% for momentum thesis). MRS_5 at 2.4% confirms short-term momentum alignment. Outperforming sector by 3.1pp, stock-specific strength. Full SMA alignment bullish (above 20/50/200 SMAs). OFD pattern: -MTL (Decline).
