...
No thesis match: MRS_20 -0.0% below STRENGTH zone (4.0-10.0%); PEG 2.37 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($60.12)
...
**1. Looking Into Interactive Brokers Group Inc's Recent Short Interest**
- Source: Sahm | 20251218T000910 | Somewhat-Bearish | Relevance: 100%
...
PEG ratio 2.37 elevated, pricing in significant growth expectations. Forward P/E 27.3x stretched relative to 11% growth. Quality metrics strong (ROE 23%, margin 15%). Balance sheet: $4.5B free cash flow. Insider selling cluster ($7.7M in 90 days), potential headwind. Institutional flow bullish (5 buying vs 5 selling).
...
MRS_20 strengthening from -1.6% to -0.0% (+1.6% in 5 days), confirming momentum buildup. Below STRENGTH zone by 4.0pp (needs >4.0% for momentum thesis). MRS_5 turning positive (0.6%) - potential reversal signal. RSI neutral at 48. OFD pattern: +MUN (Resistance test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -0.04% (CS: 51) | Neutral |
| RSI_14 | 47.7 | Neutral |
