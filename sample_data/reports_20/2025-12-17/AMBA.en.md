...
No thesis match: MRS_20 -7.8% below STRENGTH zone (4.0-10.0%); PEG 4.96 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: declining volume (51% of avg), momentum weakening (-4.5% MRS).
...
2. Momentum deterioration: MRS_20 falling (-4.5% 5d) with bearish MACD, trend may be turning.
...
MRS_20 deteriorating from -3.3% to -7.8% (-4.5% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 11.8pp (needs >4.0% for momentum thesis). AM_20 at -9.5% indicates price below own 20MA trend. Underperforming sector by 7.1pp, stock-specific weakness. Long-term uptrend intact (above SMA200 at 1.04x) but short-term weakness (below SMA20). Volume at 51% of 20MA suggests lack of conviction. OFD pattern: -MTL (Decline).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -7.80% (CS: 5) | Weak |
| RSI_14 | 36.7 | Neutral |
