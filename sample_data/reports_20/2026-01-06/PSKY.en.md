...
No thesis match: MRS_20 -8.8% below STRENGTH zone (4.0-10.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-5.8% MRS).

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($11.46)
...
**1. Netflix stock (NFLX) holds steady after hours as CFRA downgrade spotlights Warner deal risk**
...
PEG ratio 0.84 indicates undervaluation relative to growth. Forward P/E 11.9x attractive for 58% earnings growth. Analyst sentiment positive (1 raises, avg +20%, $15 target (+18%)). Institutional flow bullish (10 buying vs 0 selling).
...
MRS_20 deteriorating from -3.0% to -8.8% (-5.8% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 12.8pp (needs >4.0% for momentum thesis). AM_20 at -8.1% indicates price below own 20MA trend. Underperforming sector by 8.4pp, stock-specific weakness. Below SMA200 (0.90x), long-term trend not supportive. OFD pattern: -FTN (Decline).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -8.77% (CS: 1) | Weak |
| RSI_14 | 31.9 | Neutral |
