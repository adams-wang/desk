...
No thesis match: MRS_10 -4.3% below STRENGTH zone (3.0-6.0%). Stock is in no-man's land without clear edge.
...
MRS_10 improving modestly (+1.0% over 5 days). Below STRENGTH zone by 7.3pp (needs >3.0% for momentum thesis). Underperforming sector by 7.0pp, stock-specific weakness. Below SMA200 (0.95x), long-term trend not supportive. OFD pattern: -MTN (Decline).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -4.32% (CS: 10) | Weak |
| RSI_14 | 35.0 | Neutral |
