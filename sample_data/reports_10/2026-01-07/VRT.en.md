...
PEG ratio 0.83 indicates undervaluation relative to growth. Quality metrics strong (ROE 39%, ROA 11%). Revenue growth strong at 20% YoY. Analyst sentiment positive (3 raises, avg +11%, $208 target (+21%)). Institutional flow bullish (6 buying vs 4 selling).
...
MRS_10 improving modestly (+0.8% over 5 days). Below STRENGTH zone by 2.0pp (needs >3.0% for momentum thesis). MRS_5 (-0.9%) diverging from MRS_10 - short-term weakness emerging. MACD histogram positive (1.35), confirming momentum. RSI neutral at 52. OFD pattern: +MUL (Resistance test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 1.01% (CS: 64) | Neutral |
| RSI_14 | 51.7 | Neutral |
...
- **Entry:** $171.43
- **Stop Loss:** $153.89 (10.2% risk)
- **Target:** $188.97 (R:R method)
- **Risk/Reward:** 1.00:1
