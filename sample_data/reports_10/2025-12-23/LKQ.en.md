...
No thesis match: MRS_10 -2.1% below STRENGTH zone (3.0-6.0%); PEG 1.06 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-6.1% MRS).
...
MRS_10 deteriorating from 4.0% to -2.1% (-6.1% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 5.1pp (needs >3.0% for momentum thesis). Underperforming sector by 3.2pp, stock-specific weakness. Below SMA200 (0.86x), long-term trend not supportive. RSI neutral at 50. OFD pattern: -SLL (Support test).
...
- **Entry:** $29.99
- **Stop Loss:** $28.23 (5.9% risk)
- **Target:** $31.75 (R:R method)
- **Risk/Reward:** 1.00:1
