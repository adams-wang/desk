...
VALUE thesis: PEG 1.48 indicates fundamental undervaluation. Quality metrics strong (ROA 10%). Consistent execution (4/4 quarters beat estimates). Caution: overbought RSI (82).

- **Horizon:** 20-60 days (position)
- **Risk Profile:** Lower - fundamental undervaluation
- **Stop Type:** Fixed 2xATR ($80.43)
...
**1. Novanta (Nasdaq: NOVT) to present at J.P. Morgan 44th healthcare conf.**
- Source: Stock Titan | 20251215T160852 | Neutral | Relevance: 65%
...
**2. Infosys Sees Heavy Call Option Activity as Market Eyes December Expiry**
- Source: Markets Mojo | 20251213T220824 | Neutral | Relevance: 56%
- Infosys Ltd is experiencing significant call option trading with a strike price of ₹1,600 for the December 30, 2025 expiry, indicating bullish investor sentiment despite the stock's recent underperformance. This activity suggests market participants anticipate an upward movement beyond ₹1,600 or are hedging existing positions, amidst mixed technical signals and moderate investor participation. The heavy call option volume highlights the importance of this strike price as a key resistance or target point as the year-end expiry approaches.
...
PEG ratio 1.48 suggests fair value with growth premium. Forward P/E 15.0x stretched relative to 7% growth. Quality metrics strong (ROA 10%). Balance sheet: strong liquidity (2.4x), low leverage (D/E 0.35), $1.2B free cash flow. Analyst sentiment positive (1 raises, avg +5%). Insider selling cluster ($1.2M in 90 days), potential headwind. Institutional flow bullish (6 buying vs 4 selling).
...
MRS_20 strengthening from 4.4% to 8.0% (+3.6% in 5 days), confirming momentum buildup. Currently in upper STRENGTH zone (4.0-10.0%), cross-sectional ranking at 90th percentile. MRS_5 at 2.6% confirms short-term momentum alignment. AM_20 at 7.7% shows strong absolute momentum above own 20MA. Outperforming sector by 8.4pp, stock-specific strength. Full SMA alignment bullish (above 20/50/200 SMAs). RSI overbought at 82, risk of mean reversion. OFD pattern: -DLN (Support test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | 8.00% (CS: 90) | Strong |
| RSI_14 | 81.6 | Overbought |
...
- **Entry:** $84.05
- **Stop Loss:** $80.43 (4.3% risk)
- **Target:** $91.29 (R:R method)
- **Risk/Reward:** 2.00:1
