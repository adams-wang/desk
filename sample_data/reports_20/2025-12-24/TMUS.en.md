...
VALUE thesis: PEG 0.76 indicates fundamental undervaluation. Quality metrics strong (ROE 19%). Consistent execution (4/4 quarters beat estimates).
...
MRS_20 deteriorating from -1.0% to -2.4% (-1.4% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 6.4pp (needs >4.0% for momentum thesis). Underperforming sector by 3.1pp, stock-specific weakness. Below SMA200 (0.85x), long-term trend not supportive. RSI neutral at 42. OFD pattern: +MTL (Rally).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -2.39% (CS: 26) | Weak |
| RSI_14 | 41.6 | Neutral |
