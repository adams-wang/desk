...
No thesis match: MRS_10 -2.6% below STRENGTH zone (3.0-6.0%); PEG 3.15 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_10 stable at -2.6% (minimal 5-day change). Below STRENGTH zone by 5.6pp (needs >3.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.00x) but short-term weakness (below SMA20). MACD histogram bearish (-0.98), momentum weakening. RSI neutral at 45. OFD pattern: +MTL (Rally).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -2.59% (CS: 21) | Weak |
| RSI_14 | 44.9 | Neutral |
