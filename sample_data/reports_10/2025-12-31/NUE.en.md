...
MRS_10 stable at 0.4% (minimal 5-day change). Below STRENGTH zone by 2.6pp (needs >3.0% for momentum thesis). MRS_5 (-0.2%) diverging from MRS_10 - short-term weakness emerging. Full SMA alignment bullish (above 20/50/200 SMAs). RSI neutral at 56. OFD pattern: -MLL (Support test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 0.42% (CS: 74) | Neutral |
| RSI_14 | 56.1 | Neutral |
