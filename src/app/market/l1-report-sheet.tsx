...
export function L1ReportSheet({
  ...
  useEffect(() => {
    ...
    async function fetchReport() {
      ...
      try {
        const response = await fetch(`/api/reports/l1?date=${tradingDate}&lang=${currentLang}`);
    ...
    fetchReport();
  }, [open, reportPath, tradingDate, currentLang]);
