...
No thesis match: MRS_10 -2.1% below STRENGTH zone (3.0-6.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-4.9% MRS).
...
MRS_10 deteriorating from 2.8% to -2.1% (-4.9% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 5.1pp (needs >3.0% for momentum thesis). Below SMA200 (0.92x), long-term trend not supportive. RSI neutral at 55. OFD pattern: -STL (Decline).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -2.13% (CS: 28) | Weak |
| RSI_14 | 55.4 | Neutral |
