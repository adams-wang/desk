...
No thesis match: MRS_10 -3.2% below STRENGTH zone (3.0-6.0%); PEG 1.09 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-3.2% MRS).
...
MRS_10 deteriorating from 0.1% to -3.2% (-3.2% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 6.2pp (needs >3.0% for momentum thesis). Underperforming sector by 3.3pp, stock-specific weakness. Long-term uptrend intact (above SMA200 at 1.00x) but short-term weakness (below SMA20). RSI neutral at 42. OFD pattern: +MTL (Rally).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -3.17% (CS: 11) | Weak |
| RSI_14 | 42.0 | Neutral |
