...
VALUE thesis: PEG 1.09 indicates fundamental undervaluation. Consistent execution (4/4 quarters beat estimates). Caution: momentum weakening (-5.0% MRS).
...
MRS_20 deteriorating from 0.0% to -4.9% (-5.0% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 8.9pp (needs >4.0% for momentum thesis). AM_20 at -4.0% indicates price below own 20MA trend. Underperforming sector by 4.6pp, stock-specific weakness. Long-term uptrend intact (above SMA200 at 1.00x) but short-term weakness (below SMA20). RSI neutral at 41. OFD pattern: -SUL (Resistance).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -4.94% (CS: 12) | Weak |
| RSI_14 | 40.7 | Neutral |
