...
No thesis match: MRS_20 -0.7% below STRENGTH zone (4.0-10.0%); PEG 5.02 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_20 strengthening from -3.7% to -0.7% (+3.0% in 5 days), confirming momentum buildup. Below STRENGTH zone by 4.7pp (needs >4.0% for momentum thesis). MRS_5 turning positive (1.3%) - potential reversal signal. Long-term uptrend intact (above SMA200 at 1.23x) but short-term weakness (below SMA20). MACD histogram bearish (-1.87), momentum weakening. RSI neutral at 51. OFD pattern: +SBN (Volatile).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -0.70% (CS: 25) | Neutral |
| RSI_14 | 50.9 | Neutral |
