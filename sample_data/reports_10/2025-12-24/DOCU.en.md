...
No thesis match: MRS_10 -1.1% below STRENGTH zone (3.0-6.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-3.8% MRS).
...
MRS_10 deteriorating from 2.7% to -1.1% (-3.8% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 4.1pp (needs >3.0% for momentum thesis). Below SMA200 (0.91x), long-term trend not supportive. RSI neutral at 52. OFD pattern: +MTL (Rally).
