...
MRS_10 strengthening from 2.1% to 7.3% (+5.2% in 5 days), confirming momentum buildup. Extended beyond STRENGTH zone (7.3% > 6.0%), caution on chasing. MRS_5 at 5.0% confirms short-term momentum alignment. Outperforming sector by 5.6pp, stock-specific strength. Below SMA200 (0.94x), long-term trend not supportive. MACD histogram positive (0.69), confirming momentum. RSI overbought at 70, risk of mean reversion. OFD pattern: -SUH (Resistance).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 7.30% (CS: 91) | Strong |
