...
No thesis match: MRS_10 -0.1% below STRENGTH zone (3.0-6.0%); PEG 25.70 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_10 improving modestly (+0.9% over 5 days). Below STRENGTH zone by 3.0pp (needs >3.0% for momentum thesis). Full SMA alignment bullish (above 20/50/200 SMAs). RSI neutral at 58. OFD pattern: +SUL (Resistance test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -0.05% (CS: 72) | Neutral |
| RSI_14 | 57.5 | Neutral |
| MACD Histogram | -0.26 | Bearish |
| vs SMA20 | 1.003x | Above |
| vs SMA50 | 1.059x | Above |
| vs SMA200 | 1.595x | Above |
...
- **Entry:** $80.65
- **Stop Loss:** $76.09 (5.7% risk)
- **Target:** $85.21 (R:R method)
- **Risk/Reward:** 1.00:1
