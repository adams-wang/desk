...
No thesis match: MRS_20 -8.7% below STRENGTH zone (4.0-10.0%); PEG 1.51 fails VALUE criteria (<1.0); RSI 29 oversold (REVERSION excluded per A/B test). Stock is in no-man's land without clear edge. Caution: momentum weakening (-5.0% MRS).

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($33.78)
...
- Source: MarketBeat | 20251211T164018 | Bullish | Relevance: 92%
...
**3. Uber launches Intelligence insights platform powered by LiveRamp clean room**
- Source: PPC Land | 20251209T210956 | Somewhat-Bullish | Relevance: 57%
...
MRS_20 deteriorating from -3.6% to -8.7% (-5.0% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 12.7pp (needs >4.0% for momentum thesis). AM_20 at -6.6% indicates price below own 20MA trend. Underperforming sector by 8.9pp, stock-specific weakness. Below SMA200 (0.63x), long-term trend not supportive. RSI oversold at 29, potential bounce setup.

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -8.66% (CS: 2) | Weak |
