...
VALUE thesis: PEG 0.44 indicates fundamental undervaluation. Consistent execution (4/4 quarters beat estimates). Caution: momentum weakening (-3.0% MRS).

- **Horizon:** 20-60 days (position)
- **Risk Profile:** Lower - fundamental undervaluation
- **Stop Type:** Fixed 2xATR ($85.46)
...
PEG ratio 0.44 indicates undervaluation relative to growth. Forward P/E 24.6x stretched relative to 7% growth. Balance sheet: low leverage (D/E 0.34). Analyst sentiment negative (13 target cuts vs 2 raises). Insider selling cluster ($1.3M in 90 days), potential headwind. Institutional flow bullish (6 buying vs 4 selling).
...
MRS_20 deteriorating from 7.7% to 4.8% (-3.0% in 5 days), indicating relative weakness vs NASDAQ. Currently in lower STRENGTH zone (4.0-10.0%), cross-sectional ranking at 83rd percentile. MRS_5 (-0.4%) diverging from MRS_20 - short-term weakness emerging. AM_20 at 5.4% shows strong absolute momentum above own 20MA. Outperforming sector by 4.6pp, stock-specific strength. Below SMA200 (0.94x), long-term trend not supportive. MACD histogram positive (0.58), confirming momentum. OFD pattern: +SUL (Resistance test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | 4.76% (CS: 84) | Strong |
| RSI_14 | 62.0 | Neutral |
...
- **Entry:** $90.94
- **Stop Loss:** $85.46 (6.0% risk)
- **Target:** $101.90 (R:R method)
- **Risk/Reward:** 2.00:1
