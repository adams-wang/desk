...
VALUE thesis: PEG 0.44 indicates fundamental undervaluation. Consistent execution (4/4 quarters beat estimates). Caution: momentum weakening (-5.1% MRS).
...
PEG ratio 0.44 indicates undervaluation relative to growth. Forward P/E 24.1x stretched relative to 7% growth. Balance sheet: low leverage (D/E 0.34). Analyst sentiment negative (13 target cuts vs 2 raises). Insider selling cluster ($1.3M in 90 days), potential headwind. Institutional flow bullish (6 buying vs 4 selling).
...
MRS_20 deteriorating from 6.7% to 1.6% (-5.1% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 2.4pp (needs >4.0% for momentum thesis). MRS_5 (-2.3%) diverging from MRS_20 - short-term weakness emerging. Below SMA200 (0.92x), long-term trend not supportive. RSI neutral at 55. OFD pattern: -STL (Decline).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | 1.58% (CS: 72) | Neutral |
| RSI_14 | 55.4 | Neutral |
