...
No thesis match: MRS_20 -2.6% below STRENGTH zone (4.0-10.0%); PEG 3.15 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-2.5% MRS).

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($301.49)
...
MRS_20 deteriorating from -0.1% to -2.6% (-2.5% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 6.6pp (needs >4.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.00x) but short-term weakness (below SMA20). MACD histogram bearish (-0.98), momentum weakening. RSI neutral at 45. OFD pattern: +MTL (Rally).
...
- **Entry:** $316.93
- **Stop Loss:** $301.49 (4.9% risk)
- **Target:** $332.37 (R:R method)
- **Risk/Reward:** 1.00:1
