...
No thesis match: MRS_20 -1.1% below STRENGTH zone (4.0-10.0%); PEG 2.06 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($162.60)
...
PEG ratio 2.06 elevated, pricing in significant growth expectations. Forward P/E 19.3x stretched relative to 8% growth. Quality metrics strong (margin 26%).

| Metric | Value |
|--------|-------|
| Market Cap | $27.1B |
| Beta | 0.76 |
| 52W Range | $136.38 - $180.65 |
| Short Interest | 3.8% |
...
MRS_20 weakening modestly (-0.9% over 5 days). Below STRENGTH zone by 5.1pp (needs >4.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.03x) but short-term weakness (below SMA20). RSI neutral at 44. OFD pattern: +SUN (Resistance test).
...
- **Entry:** $167.54
- **Stop Loss:** $162.60 (2.9% risk)
- **Target:** $172.48 (R:R method)
- **Risk/Reward:** 1.00:1
