...
No thesis match: MRS_10 -1.9% below STRENGTH zone (3.0-6.0%); PEG 5.02 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($160.60)
...
MRS_10 stable at -1.9% (minimal 5-day change). Below STRENGTH zone by 4.9pp (needs >3.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.23x) but short-term weakness (below SMA20). MACD histogram bearish (-1.80), momentum weakening. RSI neutral at 50. OFD pattern: -MLN (Support test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -1.88% (CS: 18) | Neutral |
| RSI_14 | 49.9 | Neutral |
...
- **Entry:** $171.50
- **Stop Loss:** $160.60 (6.4% risk)
- **Target:** $182.40 (R:R method)
- **Risk/Reward:** 1.00:1
