...
No thesis match: MRS_10 -0.3% below STRENGTH zone (3.0-6.0%); PEG 1.39 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_10 strengthening from -1.8% to -0.3% (+1.5% in 5 days), confirming momentum buildup. Below STRENGTH zone by 3.3pp (needs >3.0% for momentum thesis). Below SMA200 (0.97x), long-term trend not supportive. RSI neutral at 44. OFD pattern: +MTN (Rally).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -0.30% (CS: 33) | Neutral |
| RSI_14 | 43.6 | Neutral |
