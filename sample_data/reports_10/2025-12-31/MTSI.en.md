...
MRS_10 improving modestly (+0.6% over 5 days). Below STRENGTH zone by 4.0pp (needs >3.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.27x) but short-term weakness (below SMA20). MACD histogram bearish (-1.56), momentum weakening. RSI neutral at 48. OFD pattern: -MTL (Decline).
