...
No thesis match: MRS_20 -0.3% below STRENGTH zone (4.0-10.0%); PEG 25.70 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: declining volume (59% of avg).
...
MRS_20 stable at -0.3% (minimal 5-day change). Below STRENGTH zone by 4.3pp (needs >4.0% for momentum thesis). MRS_5 turning positive (0.2%) - potential reversal signal. Long-term uptrend intact (above SMA200 at 1.54x) but short-term weakness (below SMA20). RSI neutral at 52. Volume at 59% of 20MA suggests lack of conviction. OFD pattern: +SUL (Resistance test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -0.34% (CS: 42) | Neutral |
| RSI_14 | 51.6 | Neutral |
