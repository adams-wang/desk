...
No thesis match: MRS_10 -0.7% below STRENGTH zone (3.0-6.0%); PEG 1.11 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-2.7% MRS).
...
MRS_10 deteriorating from 2.0% to -0.7% (-2.7% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 3.7pp (needs >3.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.02x) but short-term weakness (below SMA20). RSI neutral at 46. OFD pattern: +MTN (Rally).
