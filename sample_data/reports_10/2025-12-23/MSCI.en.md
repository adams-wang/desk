...
No thesis match: MRS_10 2.6% below STRENGTH zone (3.0-6.0%); PEG 2.01 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-3.1% MRS).
...
MRS_10 deteriorating from 5.7% to 2.6% (-3.1% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 0.4pp (needs >3.0% for momentum thesis). MRS_5 at 0.4% confirms short-term momentum alignment. Full SMA alignment bullish (above 20/50/200 SMAs). MACD histogram positive (4.31), confirming momentum. OFD pattern: +MTL (Rally).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 2.60% (CS: 94) | Neutral |
| RSI_14 | 67.9 | Neutral |
