...
MRS_10 deteriorating from 2.7% to 0.8% (-1.9% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 2.2pp (needs >3.0% for momentum thesis). MRS_5 (-0.4%) diverging from MRS_10 - short-term weakness emerging. Below SMA200 (0.93x), long-term trend not supportive. MACD histogram positive (0.63), confirming momentum. OFD pattern: -SLH (Support test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 0.82% (CS: 67) | Neutral |
| RSI_14 | 60.3 | Neutral |
