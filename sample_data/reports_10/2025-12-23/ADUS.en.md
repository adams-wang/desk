...
No thesis match: MRS_10 -3.6% below STRENGTH zone (3.0-6.0%); PEG 1.09 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-5.9% MRS).
...
MRS_10 deteriorating from 2.3% to -3.6% (-5.9% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 6.6pp (needs >3.0% for momentum thesis). Underperforming sector by 3.3pp, stock-specific weakness. Long-term uptrend intact (above SMA200 at 1.00x) but short-term weakness (below SMA20). RSI neutral at 41. OFD pattern: -SUL (Resistance).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -3.63% (CS: 12) | Weak |
| RSI_14 | 40.7 | Neutral |
