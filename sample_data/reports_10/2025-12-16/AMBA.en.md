...
No thesis match: MRS_10 -2.6% below STRENGTH zone (3.0-6.0%); PEG 4.96 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-8.6% MRS).
...
2. Momentum deterioration: MRS_10 falling (-8.6% 5d) with bearish MACD, trend may be turning.
...
MRS_10 deteriorating from 6.0% to -2.6% (-8.6% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 5.6pp (needs >3.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.07x) but short-term weakness (below SMA20). OFD pattern: -SBL (Volatile).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -2.63% (CS: 14) | Weak |
| RSI_14 | 39.1 | Neutral |
