...
No thesis match: MRS_10 0.4% below STRENGTH zone (3.0-6.0%); PEG 5.36 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_10 weakening modestly (-1.0% over 5 days). Below STRENGTH zone by 2.6pp (needs >3.0% for momentum thesis). MRS_5 (-0.1%) diverging from MRS_10 - short-term weakness emerging. Full SMA alignment bullish (above 20/50/200 SMAs). OFD pattern: +SLL (Support).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 0.36% (CS: 42) | Neutral |
| RSI_14 | 60.1 | Neutral |
