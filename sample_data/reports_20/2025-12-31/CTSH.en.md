...
No thesis match: MRS_20 0.2% below STRENGTH zone (4.0-10.0%); PEG 1.50 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-2.9% MRS).

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($80.00)
...
PEG ratio 1.50 elevated, pricing in significant growth expectations. Forward P/E 14.8x stretched relative to 7% growth. Quality metrics strong (ROA 10%). Balance sheet: strong liquidity (2.4x), low leverage (D/E 0.35), $1.2B free cash flow. Analyst sentiment positive (1 raises, avg +5%). Insider selling cluster ($3.7M in 90 days), potential headwind. Institutional flow bullish (6 buying vs 4 selling).
...
MRS_20 deteriorating from 3.1% to 0.2% (-2.9% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 3.8pp (needs >4.0% for momentum thesis). MRS_5 (-1.0%) diverging from MRS_20 - short-term weakness emerging. Long-term uptrend intact (above SMA200 at 1.11x) but short-term weakness (below SMA20). RSI neutral at 59. OFD pattern: -MTL (Decline).
...
- **Entry:** $83.00
- **Stop Loss:** $80.00 (3.6% risk)
- **Target:** $86.00 (R:R method)
- **Risk/Reward:** 1.00:1
