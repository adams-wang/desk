...
VALUE thesis: PEG 0.91 indicates fundamental undervaluation. Quality metrics strong (ROE 40%). Consistent execution (4/4 quarters beat estimates). Caution: momentum weakening (-3.0% MRS).
...
MRS_20 deteriorating from 5.0% to 1.9% (-3.0% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 2.0pp (needs >4.0% for momentum thesis). MRS_5 (-0.4%) diverging from MRS_20 - short-term weakness emerging. Full SMA alignment bullish (above 20/50/200 SMAs). RSI neutral at 52. Elevated volume (2.2x 20MA), institutional activity likely. OFD pattern: -SLH (Support test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | 1.95% (CS: 59) | Neutral |
| RSI_14 | 51.5 | Neutral |
