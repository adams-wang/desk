...
No thesis match: MRS_10 0.0% below STRENGTH zone (3.0-6.0%); PEG 1.84 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge. Caution: momentum weakening (-3.0% MRS).

- **Horizon:** N/A - no position
- **Risk Profile:** N/A - avoiding
- **Stop Type:** Fixed 2xATR ($560.90)
...
- Source: Business Wire | 20251222T140847 | Somewhat-Bullish | Relevance: 86%
...
MRS_10 deteriorating from 3.0% to 0.0% (-3.0% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 3.0pp (needs >3.0% for momentum thesis). MRS_5 (-0.0%) diverging from MRS_10 - short-term weakness emerging. Full SMA alignment bullish (above 20/50/200 SMAs). MACD histogram positive (3.13), confirming momentum. OFD pattern: +SUL (Resistance test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | 0.02% (CS: 73) | Neutral |
| RSI_14 | 65.9 | Neutral |
...
- **Entry:** $579.50
- **Stop Loss:** $560.90 (3.2% risk)
- **Target:** $598.10 (R:R method)
- **Risk/Reward:** 1.00:1
