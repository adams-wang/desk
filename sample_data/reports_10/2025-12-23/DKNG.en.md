...
No thesis match: MRS_10 -1.8% below STRENGTH zone (3.0-6.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-2.2% MRS).
...
MRS_10 deteriorating from 0.4% to -1.8% (-2.2% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 4.8pp (needs >3.0% for momentum thesis). Below SMA200 (0.91x), long-term trend not supportive. RSI neutral at 55. OFD pattern: -SLL (Support test).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -1.76% (CS: 34) | Neutral |
| RSI_14 | 55.1 | Neutral |
...
- **Entry:** $34.54
- **Stop Loss:** $31.76 (8.0% risk)
- **Target:** $37.32 (R:R method)
- **Risk/Reward:** 1.00:1
