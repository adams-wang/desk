...
No thesis match: MRS_10 -2.9% below STRENGTH zone (3.0-6.0%). Stock is in no-man's land without clear edge. Caution: momentum weakening (-5.7% MRS).
...
MRS_10 deteriorating from 2.8% to -2.9% (-5.7% in 5 days), indicating relative weakness vs NASDAQ. Below STRENGTH zone by 5.9pp (needs >3.0% for momentum thesis). Underperforming sector by 3.1pp, stock-specific weakness. Below SMA200 (0.91x), long-term trend not supportive. RSI neutral at 53. OFD pattern: -SLL (Support test).
