...
No thesis match: MRS_20 -2.2% below STRENGTH zone (4.0-10.0%); PEG 2.14 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_20 stable at -2.2% (minimal 5-day change). Below STRENGTH zone by 6.2pp (needs >4.0% for momentum thesis). Below SMA200 (0.80x), long-term trend not supportive. RSI neutral at 47.

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_20 | -2.18% (CS: 33) | Weak |
| RSI_14 | 46.6 | Neutral |
