...
No thesis match: MRS_10 -1.9% below STRENGTH zone (3.0-6.0%); PEG 3.15 fails VALUE criteria (<1.0). Stock is in no-man's land without clear edge.
...
MRS_10 improving modestly (+0.5% over 5 days). Below STRENGTH zone by 5.0pp (needs >3.0% for momentum thesis). Long-term uptrend intact (above SMA200 at 1.00x) but short-term weakness (below SMA20). MACD histogram bearish (-0.83), momentum weakening. RSI neutral at 46. OFD pattern: +MTL (Rally).

| Metric | Value | Signal |
|--------|-------|--------|
| MRS_10 | -1.95% (CS: 27) | Neutral |
| RSI_14 | 45.8 | Neutral |
